...
def _aot_stage2b_compile_forward_or_inference(
    ...
    *,
    ...
    if is_inference:
        ...
        grad_context: Any = torch.no_grad
        autocast_context: Any = torch._C._DisableAutocast
        tracking_mode: str = "forward"
        compiler: Any = aot_config.fw_compiler

    with grad_context(), autocast_context(), track_graph_compiling(
        aot_config, tracking_mode
    ):
        # Setup wrappers
